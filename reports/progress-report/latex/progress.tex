...
\begin{document}
	...
	\section{Background}
	Examining similar works will reveal that computer simulations of GRNs is a common problem among researchers. The popular GenoCAD tool offers a database of parts which the user can use to build genetic circuits and simulate them. A more general tool is COPASI which mostly focuses on simulations of biological systems (including but not limited to GRNs). 
	...
	\section{Progress}
	% TODO: You can do, so much better!
	...
	%TODO: - Platforms, frameworks, datasets etc
	%TODO: How are you doing things and what are you using to do these?
	%TODO: PyCharm?
